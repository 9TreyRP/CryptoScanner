#  Cryptocurrency-Wallet-Scanner 2025
# Volkan Kücükbudak
# https://github.com/VolkanSah/Cryptocurrency-Wallet-Scanner
# Pnly for research and education !
#!/usr/bin/env python3
import asyncio
import aiohttp
import secrets
...
async def main():
    """Main entry point"""
    if TESTMODE:
        print(f"{Colors.YELLOW}Running in TEST MODE - No live network calls{Colors.RESET}")
        time.sleep(2)
